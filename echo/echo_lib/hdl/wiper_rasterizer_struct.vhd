...
ARCHITECTURE struct OF wiper_rasterizer IS
   ...
   SIGNAL area  : UNSIGNED(20 DOWNTO 0);
   SIGNAL area1 : UNSIGNED(20 DOWNTO 0);
   SIGNAL area2 : UNSIGNED(20 DOWNTO 0);
   SIGNAL area3 : UNSIGNED(20 DOWNTO 0);
   SIGNAL area4 : UNSIGNED(20 DOWNTO 0);
   SIGNAL area5 : UNSIGNED(20 DOWNTO 0);
   SIGNAL dout  : UNSIGNED(20 DOWNTO 0);
   SIGNAL dout1 : UNSIGNED(20 DOWNTO 0);
   SIGNAL dout2 : UNSIGNED(20 DOWNTO 0);
   SIGNAL dout3 : UNSIGNED(20 DOWNTO 0);
...
BEGIN
   ...
   VARIABLE temp_din0 : unsigned(21 DOWNTO 0);
   VARIABLE temp_din1 : unsigned(21 DOWNTO 0);
   VARIABLE temp_sum : unsigned(21 DOWNTO 0);
   ...
   BEGIN
      ...
      dout2 <= resize(temp_sum(20 DOWNTO 0),21);
   ...
   BEGIN
      ...
      temp_carry(0) := dout7;
      temp_sum := temp_din0 + temp_din1 + temp_carry;
      dout1 <= resize(temp_sum(20 DOWNTO 0),21);
   ...
   BEGIN
      ...
      temp_carry(0) := dout4;
      temp_sum := temp_din0 + temp_din1 + temp_carry;
      dout3 <= resize(temp_sum(20 DOWNTO 0),21);
   ...
   BEGIN
      ...
      temp_carry(0) := dout5;
      temp_sum := temp_din0 + temp_din1 + temp_carry;
      dout <= resize(temp_sum(20 DOWNTO 0),21);
   END PROCESS u_3combo_proc;

   -- ModuleWare code(v1.12) for instance 'U_4' of 'comp'
   u_4combo_proc : PROCESS (dout2, dout3)
