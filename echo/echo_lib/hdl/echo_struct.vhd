...
--
-- Created:
--          by - antmo328.student-liu.se (muxen2-115.ad.liu.se)
--          at - 11:41:27 10/30/25
--
...
ARCHITECTURE struct OF echo IS
   ...
   PORT (
      ...
      RESET_N       : IN     std_logic ;
      clk           : IN     std_logic ;
      ctrl_sig      : OUT    std_logic_vector (5 DOWNTO 0)
   );
   END COMPONENT;
   COMPONENT sram_ctrl
   GENERIC (
   ...
   FOR ALL : kb_block USE ENTITY echo_lib.kb_block;
...
BEGIN
   ...
   U_0 : echo_logic
      GENERIC MAP (
         G_ADDR_WIDTH => 20,         -- physische Adressbreite (WORT-Adresse)
         G_DATA_WIDTH => 16
      )
      PORT MAP (
         clk             => clk,
