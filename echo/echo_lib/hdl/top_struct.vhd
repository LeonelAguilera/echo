...
ARCHITECTURE struct OF top IS
   ...
   SIGNAL mon_delay_smpl  : std_logic_vector(G_ADDR_WIDTH-2 DOWNTO 0);
   SIGNAL mon_gain_q15    : std_logic_vector(15 DOWNTO 0);
...
BEGIN
   ...
   U_0 : echo
      PORT MAP (
         ...
         mon_delay_smpl  => mon_delay_smpl,
         mon_gain_q15    => mon_gain_q15
      );
   U_5 : i2c;
   U_6 : kb_decoder;
   U_3 : vga;
